...
public class AlarmKlaxon {
        ...
        if (!AlarmInstance.NO_RINGTONE_URI.equals(instance.mRingtone)) {
            ...
            try {
                ...
                if (PowerOffAlarm.bootFromPoweroffAlarm()
                    ...
                    setBackupRingtoneToPlay(context, alarmNoise);
                ///@}
                } else {
     ...
     */
    private static void setBackupRingtoneToPlay(Context context, Uri alarmNoise) throws IOException {
        ...
        if (!TextUtils.isEmpty(ringtonePath)) {
            ...
            // if the backup ringtone not find, just use the default alarm
            sMediaPlayer.setDataSource(context, alarmNoise);
        }
    }
}
