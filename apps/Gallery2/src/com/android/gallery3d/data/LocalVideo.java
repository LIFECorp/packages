...
public class LocalVideo extends LocalMediaItem {
    ...
    // added for Livephoto
    private static final int INDEX_IS_LIVEPHOTO = 15;
    ...
    public static class LocalVideoRequest extends ImageCacheRequest {
        ...
        LocalVideoRequest(GalleryApp application, Path path, long timeModified,
            ...
            /// M: set thumbnail size to 640 if thumbnail is smaller than 640
            super(application, path, timeModified, type,
                    type == MediaItem.TYPE_THUMBNAIL ? 
                            Math.max(MediaItem.getTargetSize(type), MediaItem.THUMBNAIL_TARGET_SIZE) :
