...
public class InCallActivity extends Activity {
    ...
    public void finish() {
        ...
        /// M: For ALPS01489395. @{
        // After the incoming call disconnected, need dismiss the pending dialogs
        // example the message dialog and finish the InCallActivity.
        if (mAnswerFragment.hasPendingDialogs()) {
            Log.d(this, "dismissPending dialogs~");
