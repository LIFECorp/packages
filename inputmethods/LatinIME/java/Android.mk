...
# LCA project will slim the dict file number and size.
ifneq ($(MTK_LCA_ROM_OPTIMIZE),yes)
# Normal project will include all the dict files.
res_dirs := res_base res
else
# LCA project will only include the English dict flie, and the English dict size is slimmed also.
res_dirs := res_lca res
endif
